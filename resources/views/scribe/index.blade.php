...
List active products with optional vendor filter.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-vendors">GET /api/vendors
List all active vendors.</a>
                            </li>
...
View cart grouped by vendor.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-cart-add">
                                <a href="#endpoints-POSTapi-cart-add">POST /api/cart/add</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-cart-items--id-">
                                <a href="#endpoints-PUTapi-cart-items--id-">PUT /api/cart/items/{cartItem}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-cart-items--id-">
                                <a href="#endpoints-DELETEapi-cart-items--id-">DELETE /api/cart/items/{cartItem}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-checkout">POST /api/checkout
Validates stock, splits cart by vendor, creates orders & payments.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-orders">
                                <a href="#endpoints-GETapi-orders">GET /api/orders
List the authenticated customer's orders.</a>
                            </li>
...
Show a single order — policy ensures ownership.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-orders">
                                <a href="#endpoints-GETapi-admin-orders">GET /api/admin/orders
List all orders with optional filters: vendor_id, customer_id, status.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-orders--order_id-">
                                <a href="#endpoints-GETapi-admin-orders--order_id-">GET /api/admin/orders/{order}
Full order detail: items, quantities, totals, payment, customer, vendor.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-admin-orders--order_id--status">
                                <a href="#endpoints-PATCHapi-admin-orders--order_id--status">PATCH /api/admin/orders/{order}/status
Manually update order status.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
List active products with optional vendor filter.</h2>
...
<p>The ID of the product. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-vendors">GET /api/vendors
List all active vendors.</h2>
...
View cart grouped by vendor.</h2>
...
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-cart-items--id-">PUT /api/cart/items/{cartItem}</h2>
...
<span id="example-requests-PUTapi-cart-items--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://127.0.0.1:8000/api/cart/items/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"quantity\": 21
...
<span id="example-responses-PUTapi-cart-items--id-">
</span>
<span id="execution-results-PUTapi-cart-items--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-cart-items--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-cart-items--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-cart-items--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-cart-items--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-cart-items--id-" data-method="PUT"
      data-path="api/cart/items/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-cart-items--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-cart-items--id-"
                    onclick="tryItOut('PUTapi-cart-items--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-cart-items--id-"
                    onclick="cancelTryOut('PUTapi-cart-items--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-cart-items--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-cart-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-cart-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-cart-items--id-"
               value="consequatur"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="PUTapi-cart-items--id-"
               value="21"
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 100. Example: <code>21</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-cart-items--id-">DELETE /api/cart/items/{cartItem}</h2>
...
<span id="example-requests-DELETEapi-cart-items--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-cart-items--id-">
</span>
<span id="execution-results-DELETEapi-cart-items--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-cart-items--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-cart-items--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-cart-items--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-cart-items--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-cart-items--id-" data-method="DELETE"
      data-path="api/cart/items/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-cart-items--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-cart-items--id-"
                    onclick="tryItOut('DELETEapi-cart-items--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-cart-items--id-"
                    onclick="cancelTryOut('DELETEapi-cart-items--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-cart-items--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-cart-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-cart-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-cart-items--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the item. Example: <code>consequatur</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-checkout">POST /api/checkout
Validates stock, splits cart by vendor, creates orders &amp; payments.</h2>
...
List the authenticated customer&#039;s orders.</h2>
...
Show a single order — policy ensures ownership.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/orders/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/orders/17"
);
...
<p>The ID of the order. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-orders">GET /api/admin/orders
List all orders with optional filters: vendor_id, customer_id, status.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="vendor_id"                data-endpoint="GETapi-admin-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the vendors table. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="customer_id"                data-endpoint="GETapi-admin-orders"
               value="17"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-admin-orders"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-orders--order_id-">GET /api/admin/orders/{order}
Full order detail: items, quantities, totals, payment, customer, vendor.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/admin/orders/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/admin/orders/17"
);
...
<p>The ID of the order. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-admin-orders--order_id--status">PATCH /api/admin/orders/{order}/status
Manually update order status.</h2>
...
<div class="bash-example">
    ...
    "http://127.0.0.1:8000/api/admin/orders/17/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"status\": \"cancelled\"
